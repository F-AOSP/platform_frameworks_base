...
public class DisconnectCause {
    ...
    public static final int NO_CIRCUIT_AVAIL = 56;
    public static final int NO_ROUTE_TO_DESTINAON = 57;
    public static final int OPERATOR_DETERMINED_BARRING = 58;
    public static final int CALL_FAIL_NO_USER_RESPONDING = 59;
    public static final int CALL_FAIL_NO_ANSWER_FROM_USER = 60;
    public static final int CALL_FAIL_DESTINATION_OUT_OF_ORDER = 61;
    public static final int BEARER_CAPABILITY_NOT_AUTHORIZED = 62;
    public static final int CHANNEL_UNACCEPTABLE = 63;
    public static final int CALL_REJECTED = 64;
    public static final int NUMBER_CHANGED = 65;
    public static final int PREEMPTION = 66;
    public static final int FACILITY_REJECTED = 67;
    public static final int RESP_TO_STATUS_ENQUIRY = 68;
    public static final int NORMAL_UNSPECIFIED = 69;
    public static final int NETWORK_OUT_OF_ORDER = 70;
    public static final int TEMPORARY_FAILURE = 71;
    public static final int SWITCHING_EQUIPMENT_CONGESTION = 72;
    public static final int ACCESS_INFORMATION_DISCARDED = 73;
    public static final int REQUESTED_CIRCUIT_OR_CHANNEL_NOT_AVAILABLE = 74;
    public static final int RESOURCES_UNAVAILABLE_OR_UNSPECIFIED = 75;
